...
object ApiError {
  ...
  final val ERROR_EMAIL_PASSWORD_FALSE = 112
  ...
  def errorEmailOrPassword(implicit m: Messages) = apply(ERROR_EMAIL_PASSWORD_FALSE, Messages("api.error.user.email.unconfirmed"))
