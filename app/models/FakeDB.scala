...
object FakeDB {
  ...
  val apiKeys = FakeTable(
    1L -> ApiKey(apiKey = "AbCdEfGhIjK1", name = "ios-assets.app", active = true),
    2L -> ApiKey(apiKey = "AbCdEfGhIjK2", name = "android-assets.app", active = true)
  )
  ...
  // USERS
  val users = FakeTable( //1L -> User(1L, "user1@mail.com", "123456", "User 1", true, true),
